...
import { useGmailApi } from "../context/GmailApiProvider";
...
function Gmail() {
        ...
        <div className="emailDetailHeader">
          ...
          >
            ...
            <div>
              ...
              <h3 style={{ color: "grey", fontWeight: "500", fontSize: 15 }}>
                To: {selectedEmail.to}
              </h3>
            </div>
          </div>
  ...
  function sendMessage() {
    ...
    const base64EncodedEmail = btoa(
      unescape(encodeURIComponent(emailLines.join("\n")))
    )
      .replace(/\+/g, "-")
      .replace(/\//g, "_")
      .replace(/=+$/, "");
  ...
  function Unauthenticated() {
    ...
    useEffect(() => {
      const fetchMessages = async () => {
        if (gapiNEW) {
          console.log("Connected with Gmail API...", gapiNEW);

          const authInstance = window.gapi.auth2.getAuthInstance();
          console.log("Auth: ", authInstance);

          const profileDetails = authInstance.currentUser
            .get()
            .getBasicProfile();

          console.log("Profile:", profileDetails);

          // Get user emails and messages
          gapiNEW.client.gmail.users.messages
            .list({
              userId: "me",
              maxResults: 10,
            })
            .then((response) => {
              ...
              const messagePromises = messageIds.map((message) =>
              ...
              Promise.all(messagePromises).then((fullMessages) => {
                const inboxData = fullMessages.map((message) => {
                  return {
                    id: message.id,
    ...
    return (
      <div>
        <div className={`extra-sidebar-2 slide-in`}>
          ...
          <div
            style={{
              backgroundColor: activeEmailLink === "INBOX" ? "#e1eeff" : "",
            }}
            className="option"
            onClick={() => {
              setEmailLink("INBOX");
          ...
          >
            ...
            <p
              style={{
                fontWeight: activeEmailLink === "INBOX" ? "600" : "",
                color: activeEmailLink === "INBOX" ? "#0d68c5" : "black",
              }}
            >
              Inbox
            </p>
          ...
          <div
            style={{
              backgroundColor: activeEmailLink === "DRAFTS" ? "#e1eeff" : "",
            }}
            className="option"
            onClick={() => {
              setEmailLink("DRAFTS");
          ...
          >
            <img
              src={assignmentIcon}
              alt="Automatic Assignment"
              className="option-icon"
            />
            <p
              style={{
                fontWeight: activeEmailLink === "DRAFTS" ? "600" : "",
                color: activeEmailLink === "DRAFTS" ? "#0d68c5" : "black",
              }}
            >
              Drafts
            </p>
          ...
          <div
            style={{
              backgroundColor: activeEmailLink === "OUTBOX" ? "#e1eeff" : "",
            }}
            className="option"
            onClick={() => {
              setEmailLink("OUTBOX");
          ...
          >
            ...
            <p
              style={{
                fontWeight: activeEmailLink === "OUTBOX" ? "600" : "",
                color: activeEmailLink === "OUTBOX" ? "#0d68c5" : "black",
              }}
            >
              Outbox
            </p>
          ...
          <div
            style={{
              backgroundColor: activeEmailLink === "SENT" ? "#e1eeff" : "",
            }}
            className="option"
            onClick={() => {
              setEmailLink("SENT");
          ...
          >
            ...
            <p
              style={{
                fontWeight: activeEmailLink === "SENT" ? "600" : "",
                color: activeEmailLink === "SENT" ? "#0d68c5" : "black",
              }}
            >
              Sent
            </p>
          ...
          <div
            style={{
              backgroundColor: activeEmailLink === "ARCHIVE" ? "#e1eeff" : "",
            }}
            className="option"
            onClick={() => {
          ...
          >
            ...
            <p
              style={{
                fontWeight: activeEmailLink === "ARCHIVE" ? "600" : "",
                color: activeEmailLink === "ARCHIVE" ? "#0d68c5" : "black",
              }}
            >
              Archive
            </p>
        ...
        <div className="email-content">
          <div style={{ margin: "40px 20px" }}>
            ...
            <p style={{ fontSize: "16px", color: "black" }}>
              Connect your email accounts to manage sales conversations in
              Pipedrive. Close deals faster.
            </p>
          </div>
          <div style={{ backgroundColor: "#f8f8fe", padding: "50px 60px" }}>
            ...
            >
              Connect your email accounts. Link sales emails to{" "}
              <strong>deals,</strong> <strong>leads</strong> or{" "}
            ...
            <p
              style={{ color: "#C82627", fontWeight: "500", margin: "10px 0" }}
            >
              {error}
            </p>
            {!isSignedIn ? (
              ...
              <div className="main__body">
                <div className="sidebar">
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.inboxActive === true
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.starredActive === true
                      ? "sidebarOption__active"
                      : ""
                      }`}
                  >
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.snoozeActive === true
                      ? "sidebarOption__active"
                      : ""
                      }`}
                  >
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.importantActive === true
                      ? "sidebarOption__active"
                      : ""
                      }`}
                  >
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.sentItemsActive === true
                      ? "sidebarOption__active"
                      : ""
                      }`}
                  >
                  ...
                  <div
                    ...
                    className={`sidebarOption ${activeTab?.draftsActive === true
                      ? "sidebarOption__active"
                      : ""
                      }`}
                  >
                ...
                <div className="emailList">
                  ...
                  <div className="emailList__sections">
                    <div
                      onClick={() => setHeaderActive({ primaryActive: true })}
                      className={`section ${headerActive.primaryActive === true
                        ? "section__selected"
                        : ""
                        }`}
                    >
                    ...
                    <div
                      onClick={() => setHeaderActive({ socialActive: true })}
                      className={`section ${headerActive.socialActive === true
                        ? "section__selected"
                        : ""
                        }`}
                    >
                    ...
                    <div
                      onClick={() =>
                        setHeaderActive({ promotionsActive: true })
                      }
                      className={`section ${headerActive.promotionsActive === true
                        ? "section__selected"
                        : ""
                        }`}
                    >
